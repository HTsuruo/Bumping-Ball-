...
struct ColorUtil {
    static let main = UIColor.hex(hexStr: "101B38", alpha: 1.0)
    ...
    static let text = UIColor.hex(hexStr: "464B51", alpha: 1.0)
    ...
    static let hardmode = UIColor.hex(hexStr: "851818", alpha: 1.0)
    static let impossiblemode = UIColor.hex(hexStr: "572479", alpha: 1.0)
}
